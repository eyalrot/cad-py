...
class CADApplication(QObject):
    ...
    # Signals
    document_opened = pyqtSignal(str)  # document_id
    document_closed = pyqtSignal(str)  # document_id
    current_document_changed = pyqtSignal(str)  # document_id
    ...
    def _load_settings(self):
        ...
        try:
            ...
            self._recent_files = [
                ...
                if Path(f).exists()
            ][:10]  # Keep only last 10 existing files
