...
from PyQt6.QtWidgets import QApplication, QGraphicsScene, QGraphicsLineItem, QGraphicsEllipseItem
from PyQt6.QtGui import QLineF

from qt_client.core.snap_engine import SnapEngine, SnapType, SnapPoint
...
class TestSnapEngine:
    ...
    def test_circle_quadrant_snap(self, qapp, scene, snap_engine):
        ...
        # Create a circle
        circle = QGraphicsEllipseItem(QRectF(-25, -25, 50, 50))  # Center at (0, 0), radius 25
        scene.addItem(circle)
    ...
    def test_snap_settings(self, snap_engine):
        ...
        assert set(restored_settings["active_snaps"]) == set(initial_settings["active_snaps"])
