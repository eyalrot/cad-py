...
class CADGrpcService:
    ...
    def __init__(self):
        ...
        self.drawing_service = DrawingService(self.document_service, self.entity_service)
    ...
    def GetDocumentStatistics(self, request: Dict[str, Any], context=None) -> Dict[str, Any]:
    ...
    def QueryEntities(self, request: Dict[str, Any], context=None) -> Iterator[Dict[str, Any]]:
    ...
    # Batch operations
    def BatchCreateEntities(self, request: Dict[str, Any], context=None) -> Dict[str, Any]:
        """Create multiple entities in a batch."""
        return self.entity_service.batch_create_entities(request)
    
    def BatchDeleteEntities(self, request: Dict[str, Any], context=None) -> Dict[str, Any]:
