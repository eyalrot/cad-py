...
class EntityService:
    ...
    def create_entity(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return ProtobufConverters.create_success_response({"entity": entity_proto})
    ...
    def get_entity(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"entity": entity_proto, "found": True, "error_message": ""}

        except Exception as e:
            logger.error(f"Error getting entity: {e}")
            return {"found": False, "error_message": f"Failed to get entity: {str(e)}"}
    ...
    def query_entities(self, request: Dict[str, Any]) -> Iterator[Dict[str, Any]]:
        ...
        try:
            ...
            if "filter" in request:
                entity_filter = ProtobufConverters.entity_filter_from_proto(
                    request["filter"]
                )
    ...
    def move_entities(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Moved {moved_count} entities to layer {target_layer_id} in document {document_id}"
            )
    ...
    def batch_create_entities(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Batch created {len(created_entities)} entities in document {document_id}"
            )
    ...
    def batch_delete_entities(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Batch deleted {deleted_count} entities from document {document_id}"
            )
