...
class DrawingService:
    ...
    def __init__(self, document_service: DocumentService, entity_service: EntityService):
    ...
    def draw_line(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Drew line from ({start_x}, {start_y}) to ({end_x}, {end_y}) in document {document_id}")
    ...
    def draw_circle(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Drew circle at ({center_x}, {center_y}) with radius {radius} in document {document_id}")
    ...
    def draw_arc(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not center_point or radius is None or start_angle is None or end_angle is None:
                return ProtobufConverters.create_error_response(
            ...
            logger.info(f"Drew arc at ({center_x}, {center_y}) with radius {radius} from {start_angle}° to {end_angle}° in document {document_id}")
    ...
    def draw_rectangle(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Drew rectangle from ({x1}, {y1}) to ({x2}, {y2}) in document {document_id}")
    ...
    def draw_polygon(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Drew polygon with {len(vertices)} vertices (closed: {closed}) in document {document_id}")
