...
class TestDocumentService:
    ...
    def test_save_nonexistent_document(self):
        ...
        request = {"document_id": "nonexistent", "file_path": "test.json"}
    ...
    def test_load_document(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Save document
            save_request = {"document_id": document_id, "file_path": str(file_path)}
    ...
    def test_update_nonexistent_document(self):
        ...
        request = {"document_id": "nonexistent", "name": "New Name"}
