...
class CADDocument:
    ...
    def remove_layer(self, layer_id: str) -> bool:
        ...
        entities_on_layer = [e for e in self._entities.values() if e.layer_id == layer_id]
        if entities_on_layer:
            raise ValueError(f"Cannot remove layer with {len(entities_on_layer)} entities")
    ...
    def query_entities(self, filter_obj: Optional[EntityFilter] = None) -> List[BaseEntity]:
    ...
    def move_entities_to_layer(self, entity_ids: List[str], target_layer_id: str) -> int:
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'entities': {eid: entity.serialize() for eid, entity in self._entities.items()}
        }
    ...
    def deserialize(cls, data: Dict[str, Any]) -> 'CADDocument':
        ...
        doc._current_layer_id = data.get('current_layer_id', list(doc._layers.keys())[0])
    ...
    def __repr__(self) -> str:
        ...
        return (f"CADDocument(name='{self.name}', "
