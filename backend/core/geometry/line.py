...
class Line:
    ...
    def intersections_with_circle(self, center: Point2D, radius: float) -> List[Point2D]:
        """
    ...
    @classmethod
    def from_tuple(cls, coords: Tuple[Tuple[float, float], Tuple[float, float]]) -> 'Line':
        """
    ...
    @classmethod
    def from_point_and_vector(cls, point: Point2D, vector: Vector2D, length: float = None) -> 'Line':
        """
    ...
    @classmethod
    def from_point_and_angle(cls, point: Point2D, angle: float, length: float) -> 'Line':
        """
