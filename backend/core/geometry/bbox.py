...
class BoundingBox:
    ...
    def contains_bbox(self, other: 'BoundingBox', inclusive: bool = True) -> bool:
        ...
        """
        return (self.contains_point(other.min_point, inclusive) and
                self.contains_point(other.max_point, inclusive))
    ...
    def scale(self, sx: float, sy: float = None, center: Point2D = None) -> 'BoundingBox':
        """
    ...
    @classmethod
    def from_tuple(cls, coords: Tuple[Tuple[float, float], Tuple[float, float]]) -> 'BoundingBox':
        """
    ...
    @classmethod
    def from_center_and_size(cls, center: Point2D, width: float, height: float) -> 'BoundingBox':
        """
