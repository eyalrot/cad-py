...
class Arc:
    ...
    def __init__(self, center: Point2D, radius: float, start_angle: float, end_angle: float, counterclockwise: bool = True) -> None:
        """
        Initialize an arc.
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.center == other.center and 
                abs(self.radius - other.radius) < tolerance and
                abs(self.start_angle - other.start_angle) < tolerance and
                abs(self.end_angle - other.end_angle) < tolerance and
                self.counterclockwise == other.counterclockwise)
    
    def __hash__(self) -> int:
        """Hash function for use in sets and dictionaries."""
        return hash((self.center, round(self.radius, 10), 
                    round(self.start_angle, 10), round(self.end_angle, 10),
    ...
    def tangent_at_point(self, point: Point2D) -> Vector2D:
        ...
        tangent = radius_vec.perpendicular() if self.counterclockwise else radius_vec.perpendicular_cw()
    ...
    def reverse(self) -> 'Arc':
        ...
        """
        return Arc(self.center, self.radius, self.end_angle, self.start_angle, not self.counterclockwise)
    ...
    def translate(self, dx: float, dy: float) -> 'Arc':
        ...
        return Arc(new_center, self.radius, self.start_angle, self.end_angle, self.counterclockwise)
    ...
    def rotate(self, angle: float, center: Point2D = None) -> 'Arc':
        ...
        return Arc(new_center, self.radius, new_start_angle, new_end_angle, self.counterclockwise)
    ...
    def scale(self, factor: float, center: Point2D = None) -> 'Arc':
        ...
        return Arc(new_center, new_radius, self.start_angle, self.end_angle, self.counterclockwise)
    ...
    def split_at_angle(self, angle: float) -> Tuple['Arc', 'Arc']:
        ...
        arc1 = Arc(self.center, self.radius, self.start_angle, angle, self.counterclockwise)
        arc2 = Arc(self.center, self.radius, angle, self.end_angle, self.counterclockwise)
    ...
    def to_tuple(self) -> Tuple[Tuple[float, float], float, float, float, bool]:
        ...
        """
        return (self.center.to_tuple(), self.radius, self.start_angle, self.end_angle, self.counterclockwise)
    
    @classmethod
    def from_tuple(cls, data: Tuple[Tuple[float, float], float, float, float, bool]) -> 'Arc':
        """
    ...
    def from_three_points(cls, p1: Point2D, p2: Point2D, p3: Point2D) -> 'Arc':
        ...
        return cls(circle.center, circle.radius, start_angle, end_angle, counterclockwise)
    
    @classmethod
    def from_center_start_end(cls, center: Point2D, start: Point2D, end: Point2D, counterclockwise: bool = True) -> 'Arc':
        """
